...
describe('marketing', () => {
    ...
    const expected = [
      {
        id: 1,
        product_id: 1,
        picture: `http://127.0.0.1:${PORT}/assets/campaigns/1_keyvisual.jpg`,
        story: '測試1',
      },
      {
        id: 2,
        product_id: 2,
        picture: `http://127.0.0.1:${PORT}/assets/campaigns/2_keyvisual.jpg`,
        story: '測試2',
      },
      {
        id: 3,
        product_id: 3,
        picture: `http://127.0.0.1:${PORT}/assets/campaigns/3_keyvisual.jpg`,
        story: '測試3',
      },
    ];
  ...
  it('get hot data', async () => {
    ...
    const expected = {
      ...
      main_image: `http://127.0.0.1:${PORT}/assets/products/1_main.jpg`,
      images: [
        `http://127.0.0.1:${PORT}/assets/products/1_0.jpg`,
        `http://127.0.0.1:${PORT}/assets/products/1_1.jpg`,
        `http://127.0.0.1:${PORT}/assets/products/1_0.jpg`,
        `http://127.0.0.1:${PORT}/assets/products/1_1.jpg`,
      ],
    };
